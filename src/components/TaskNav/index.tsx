...
const TaskNav: React.FC<TaskNavProps> = ({ onButtonClick, activeButton }) => {
  ...
  return (
    <div
      dir="rtl"
      className="font-iranyekan flex border-b-[0.5px] border-[#AAAAAA] justify-between w-[1033px] h-[64px] pt-[16px] pb-[16px] mt-[41px] mr-[16px]"
    >
      <div className="flex">
        ...
        <div className="border-l-[0.5px] border-[#AAAAAA] pr-[16px] pl-[16px] ">
          <button
            className={isButtonActive("listview")}
        ...
        <div className="border-l-[0.5px] border-[#AAAAAA] pr-[16px] pl-[16px] ">
          <button
            className={isButtonActive("columnview")}
            onClick={() => handleButtonClick("columnview")}
          >
            <div className="flex  gap-[5px]">
        ...
        <div className="border-l-[0.5px] border-[#AAAAAA] pr-[16px] pl-[16px] flex gap-[5px] ">
          <button
            className={isButtonActive("calendar")}
